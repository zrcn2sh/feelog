...
class AuthService {
  ...
  static bool get _hasValidGoogleWebClientId {
    final id = AppSecret.googleWebClientId.trim();
    if (id.isEmpty) return false;
    if (id.startsWith('YOUR_')) return false; // example placeholder 차단
